...
# Flash softdevice
flash_softdevice:
	@echo Flashing: s140_nrf52840_5.0.0-1.alpha_softdevice.hex
	nrfjprog --program $(SDK_ROOT)/components/softdevice/s140/hex/s140_nrf52840_5.0.0-1.alpha_softdevice.hex -f nrf52 --sectorerase 
	nrfjprog --reset -f nrf52
